...
public class Gwt implements EntryPoint {
	...
	// media notifier
	/*
	 * this.addElement("mediaNotifier", new Test() { private Notifier notifier;
	 * 
	 * @Override public Widget getWidget() { this.notifier = Notifier.createMediaNotifier(); return this.notifier; }
	 * 
	 * @Override public void run() { this.notifier.run();
	 * 
	 * } });
	 */
	...
	// forum notifier
	/*
	 * this.addElement("forumNotifier", new Test() { private Notifier notifier;
	 * 
	 * @Override public Widget getWidget() { this.notifier = Notifier.createForumNotifier(); return this.notifier; }
	 * 
	 * @Override public void run() { this.notifier.run();
	 * 
	 * } });
	...
	this.addImageSelector("imageHeadHorse", "fieldHeadPicture");

	this.addImageSelector("imageBodyHorse", "fieldBodyPicture");
    }
