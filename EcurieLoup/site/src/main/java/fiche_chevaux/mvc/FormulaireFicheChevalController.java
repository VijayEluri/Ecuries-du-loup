...
public class FormulaireFicheChevalController {
	...
	if (fiche.getPhoto() != null) {
	    ficheFormulaire.setPhotoCorps(fiche.getPhoto());
	} else {
    ...
    private Fiche ficheFormulaireToFicheExistante(FicheFormulaire ficheFormulaire) {
	...
	fiche.setPhoto(ficheFormulaire.getPhotoCorps());
    ...
    private void supprimerSurnomPlusUtiliser(Fiche fiche, FicheFormulaire ficheFormulaire) {
	List<Surnom> surnomDejaDansBase = this.ficheChevauxManager.recupererSurnoms(fiche);
