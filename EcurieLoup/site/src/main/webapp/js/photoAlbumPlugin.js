...
*/
    ...
    var parseXml = function(element, xml) {
    	$(element).empty();
    	$(xml).find('media').each( function(){
    		...
    		appendPhoto(element, {id: id, description: description, datePostage : datePostage, type : type});
		});
    };
    
    var appendPhoto = function(element, photo) {
    	var html = "<a href='"+ctx+"/albumPhoto/affichagePhoto.do?idPhoto="+photo.id+"'>";
