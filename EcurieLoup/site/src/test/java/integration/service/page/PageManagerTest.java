...
public class PageManagerTest extends DataBaseServiceWithLongIdAndOrdonnerIntegrationTest<Page> {
    ...
    @Before
    public void setUp() {
	this.service = (DataBaseService<Page>) this.context.getBean("pageManager");
    }
	...
	pageSouhaitee1.setTitle("title");
	pageSouhaitee1.setDescription("description");
	pageSouhaitee1.setOrdre(1);
	pageSouhaitee1.setContent("contenu de test");
	pageSouhaitee1.setVisible(true);
	pagesSouhaitee.add(pageSouhaitee1);

	List<Page> pagesVisibles = ((PageManager) this.service).recuperePagesVisibles();
