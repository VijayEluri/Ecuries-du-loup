...
public class EdlCodeHTMLTest {
	...
	this.edlCode.setSmileyManager(this.smileyManager);
	this.edlCode.setOptionsService(this.optionsService);
    ...
    /*
     * @Test public void testTitreTropPetit() { String texte = "[titre=7]Titre[/titre]"; this.testErreurDuParsage(texte); }
     */
    ...
    /*
     * @Test public void testListe() { String texte = "\t* objet 1\n\t* objet 2"; String resultatAttendu = "<ul><li>objet 1</li><li>objet 2</li><ul>"; this.testEgaliteDuParsage(texte,
     * resultatAttendu); }
     * 
     * @Test public void testListeDouble() { String texte = "\n\t*objet 1\n\t* objet 2\nrien\t* objet 1\n\t* objet 2"; String resultatAttendu =
     * "<ul><li>objet 1</li><li>objet 2</li><ul>rien<ul><li>objet 1</li><li>objet 2</li><ul>"; this.testEgaliteDuParsage(texte, resultatAttendu); }
     */
	...
	String resultatAttendu = "<div class=\"edl_block\" height=\"80%\" width=\"90%\" style=\"top:150px;left:47px;\">abcdef<strong>test gras</strong>aaa</div>";
	this.testEgaliteDuParsage(texte, resultatAttendu);
    }
	...
	String resultatAttendu = "azerty<div class=\"edl_block\" height=\"80%\" width=\"90%\" style=\"top:150px;left:47px;\">abcdef<strong>test gras</strong>aaa</div>qwerty<div class=\"edl_block\" height=\"160px\" width=\"130px\" style=\"top:153px;left:49px;\">fedcba<strong>test gras</strong>aaa</div>fin";
	this.testEgaliteDuParsage(texte, resultatAttendu);
    }
}
