...
public class EdlCodeCSSTest {
	...
	String resultatAttendu = "<strong>test gras</strong>";
	this.testEgaliteDuParsage(texte, resultatAttendu);
    }
	...
	String resultatAttendu = "<strong>test gras</strong> test pas gras <strong>test gras</strong>";
	this.testEgaliteDuParsage(texte, resultatAttendu);
    }
	...
	String resultatAttendu = "<strong><strong>test gras plus</strong></strong> test pas gras";
	this.testEgaliteDuParsage(texte, resultatAttendu);
    }
	...
	String resultatAttendu = "<strong>gras moins<strong>test gras plus</strong>gras moins apres</strong> test pas gras";
	this.testEgaliteDuParsage(texte, resultatAttendu);
    }
